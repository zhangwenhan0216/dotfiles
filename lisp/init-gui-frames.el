...
(defun wh/adjust-opacity (frame incr)
...
(global-set-key (kbd "M-C-8") (lambda () (interactive) (wh/adjust-opacity nil -2)))
(global-set-key (kbd "M-C-9") (lambda () (interactive) (wh/adjust-opacity nil 2)))
